...
#=====================Stream call and output========================#
# responses = generate_message_stream(bedrock_runtime, model_id, system_prompt, messages, max_tokens)
#
# if responses:
...
##只输出字
# for event in responses:
#     chunk = event.get('chunk').get('bytes').decode()
#     chunk_obj =  json.loads(chunk)
#     if chunk_obj["type"] == "content_block_delta":
#         # 访问"text"的值
#         text_value = chunk_obj["delta"]["text"]
#         print(text_value)  # 输出: 的
#
#=====================Stream call and output========================#
